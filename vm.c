...
//   unused phys mem KERNBASE..KERNBASE+1M: mapped to 0..1M
//   KERNBASE+1M..KERNBASE+end : mapped to 1M..end (mapped without write
//   permission) KERNBASE+end..KERBASE+PHYSTOP     : mapped to end..PHYSTOP (rw
//   data + free memory) 0xfe000000..0    : mapped direct (devices such as
//   ioapic)
//
...
static struct kmap {
  ...
  int perm;
    ...
    {P2V(0), 0, 1024 * 1024,
     PTE_W}, // First 1Mbyte contains BIOS and some IO devices
